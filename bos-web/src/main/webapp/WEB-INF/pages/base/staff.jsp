...
<script type="text/javascript">
	...
	function doDelete(){
		...
		if(rows.length == 0){
			$.messager.alert("信息提示","没有选择要删除的取派员!","waring");
		}else{
			$.messager.confirm("删除确认", "确定要删除选中的数据吗?", function(isTrue){
				if(isTrue){
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<!-- 修改取派员 -->
	<div class="easyui-window" title="对收派员进行添加或者修改" id="editStaffWindow" collapsible="false" minimizable="false" maximizable="false"
		style="top: 20px; left: 200px">
		<div region="north" style="height: 31px; overflow: hidden;" split="false" border="false">
			<div class="datagrid-toolbar">
				<a id="edit" icon="icon-edit" href="javascript:;"
